...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (error) {
      ...
      // Use appendResponseMessages safely if it's available and needed
      // For now, just log the error to avoid potential issues during UI updates
      // Consider adding a state variable to display the error message in the UI
    }
  }, [error, messages]); // Added messages dependency if appendResponseMessages is used
