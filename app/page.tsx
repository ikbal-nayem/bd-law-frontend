							...
							<Card className='border-green-200 shadow-lg'>
								<CardContent className='pt-6'>
									...
									<h2 className='text-2xl font-bold text-center mb-4'>
										Welcome to Bangladesh Constitution AI
									</h2>

									<p className='text-gray-600 mb-4 text-center'>
										Ask any question about the Constitution of Bangladesh and get accurate, helpful answers
										instantly.
									</p>
									...
									{messages.length === 0 ? (
										<div className='h-full flex flex-col items-center justify-center text-center p-4'>
											...
											<h3 className='text-xl font-medium text-gray-700 mb-2'>
												Ask about Bangladesh Constitution
											</h3>
											<p className='text-gray-500 max-w-md'>
												Ask questions about rights, amendments, articles, or any aspect of the Bangladesh
												Constitution.
											</p>
										</div>
									) : (
